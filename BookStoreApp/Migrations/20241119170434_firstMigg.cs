        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_sellers_libraries_LibraryId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    BooksBookId = table.Column<int>(type: "int", nullable: false),
                    librariesLibraryId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookLibrary", x => new { x.BooksBookId, x.librariesLibraryId });
                    table.ForeignKey(
                        name: "FK_BookLibrary_books_BooksBookId",
                        column: x => x.BooksBookId,
                        principalTable: "books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookLibrary_libraries_librariesLibraryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookLibrary_librariesLibraryId",
                table: "BookLibrary",
